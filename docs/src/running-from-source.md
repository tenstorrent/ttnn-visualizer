...
**NOTE:** If you're just looking to run the app, [installing via PyPI](https://docs.tenstorrent.com/ttnn-visualizer/src/getting-started.html#installing-from-pypi) or using the [hosted version](https://ttnn-visualizer.tenstorrent.com/) is highly recommended.
