...
(function () {
    ...
    function buildPageToc() {
        ...
        var content = document.querySelector('.rst-content .document') || document.querySelector('.rst-content');
        if (!content) return;
        ...
        headings.forEach(function (h) {
            ...
            clone.querySelectorAll('a.headerlink').forEach(function (el) {
                el.remove();
            });
    ...
    function setupScrollSpy(headings, ul) {
        ...
        var navbarHeight = parseInt(
            getComputedStyle(document.documentElement).getPropertyValue('--tt-navbar-height') || '72',
            10,
        );
