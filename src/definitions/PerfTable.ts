...
export enum ColumnKeys {
    ...
    DEVICE_FW_START_CYCLE = 'device_fw_start_cycle',
    DEVICE_FW_END_CYCLE = 'device_fw_end_cycle',
    METAL_TRACE_ID = 'metal_trace_id',
    METAL_TRACE_REPLAY_SESSION_ID = 'metal_trace_replay_session_id',
    Dram = 'dram',
...
export const Columns: ColumnDefinition[] = [
    ...
    { name: 'Available Cores', key: ColumnKeys.AVAILABLE_CORES, sortable: true },
    { name: 'FW Start Cycle', key: ColumnKeys.DEVICE_FW_START_CYCLE, sortable: true },
    { name: 'FW End Cycle', key: ColumnKeys.DEVICE_FW_END_CYCLE, sortable: true },
    { name: 'Metal Trace ID', key: ColumnKeys.METAL_TRACE_ID, sortable: true },
    { name: 'Metal Trace Replay Session ID', key: ColumnKeys.METAL_TRACE_REPLAY_SESSION_ID, sortable: true },
