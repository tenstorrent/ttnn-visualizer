...
export const REMOTE_TEST_IDS = Object.freeze({
    FOLDER_SELECTOR_BUTTON: TEST_IDS.REMOTE_FOLDER_SELECTOR_BUTTON,
    SYNC_DISABLED: TEST_IDS.REMOTE_SYNC_DISABLED,
    ADD_CONNECTION: TEST_IDS.ADD_NEW_CONNECTION,
    NO_CONNECTION: TEST_IDS.NO_CONNECTION,
    FETCH_FOLDERS: TEST_IDS.FETCH_REMOTE_FOLDERS,
});
